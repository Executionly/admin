...
export const PERMISSIONS = {
  // Dashboard
  VIEW_DASHBOARD:       ['super_admin', 'admin', 'support', 'developer'],
  // Users
  ...
  // Support
  VIEW_SUPPORT:         ['super_admin', 'admin', 'support'],
  MANAGE_SUPPORT:       ['super_admin', 'admin', 'support'],
  // Chat
  VIEW_CHAT:            ['super_admin', 'admin', 'support', 'developer'],
  // Affiliates
  VIEW_AFFILIATES:      ['super_admin', 'admin'],
  MANAGE_AFFILIATES:    ['super_admin', 'admin'],
  // Admins
  VIEW_ADMINS:          ['super_admin'],
  MANAGE_ADMINS:        ['super_admin'],
  // Logs
  VIEW_LOGS:            ['super_admin', 'admin', 'developer'],
  // Settings
